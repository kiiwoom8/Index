...
std::map<std::string, std::string> items = {
        ...
        {"1-1-2-5", "Nervous System Disorders"},
        ...
        {"1-4-1-1", "The Ups and Donws of the Action Potential"},
        ...
        {"1-4-3-3", "Putting the Piecies Together"},
        ...
        {"1-5-3", "Principles of Synaptic Intergration"},
        ...
        { "1-7-2-7", "Putting the Piecies Together" },
